...
const sidebarBackupButton = document.getElementById("sidebar-backup");
const sidebarExitButton = document.getElementById("sidebar-exit");
...
if (sidebarBackupButton) {
  sidebarBackupButton.addEventListener("click", () => {
    backupButton?.click();
  });
}

if (sidebarExitButton) {
  sidebarExitButton.addEventListener("click", () => {
    window.close();
  });
}

const registerScrollButtons = () => {
